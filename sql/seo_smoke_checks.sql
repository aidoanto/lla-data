...
FROM `{searchconsole_project_id}.{searchconsole_dataset}.curated_search_site_daily`
UNION ALL
...
FROM `{searchconsole_project_id}.{searchconsole_dataset}.curated_search_query_page_daily`
UNION ALL
...
FROM `{searchconsole_project_id}.{searchconsole_dataset}.seo_page_daily`;
